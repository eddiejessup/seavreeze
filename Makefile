...
cv_html:
	${BUILD_CMD} -f html -t ${CV_HTML_TEMPLATE_FILE} -d ${DATA_HTML_FILE} -o ${CV_HTML_FILE}
...
cv_tex: build_dir
	${BUILD_CMD} -f tex -t ${CV_TEX_TEMPLATE_FILE} -d ${DATA_TEX_FILE} -o ${CV_TEX_FILE}

cover_tex: build_dir
	${BUILD_CMD} -f tex -t ${COVER_TEX_TEMPLATE_FILE} -d ${DATA_TEX_FILE} -o ${COVER_TEX_FILE}
