...
\begin{document}
    ...
    \begin{letter}{}
        ...
        I'm currently finishing writing my thesis towards a \smaller{PhD} in computational Biophysics in the Living Matter group in the Physics department of Edinburgh University. Before then I graduated from Durham University, where I studied Theoretical Physics. My \smaller{PhD} has consisted mainly of analysing the movement of large numbers of bacteria in confining environments, through numerical simulations and statistical analysis of experimental data.
